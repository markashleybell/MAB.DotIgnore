...
The goal of this library is to implement the same file matching behaviour which [Git](https://github.com/git/git) uses to determine which files to ignore when adding to a commit. Please submit [issues](https://github.com/markashleybell/MAB.DotIgnore/issues) or pull requests if you find instances where this isn't the case.
